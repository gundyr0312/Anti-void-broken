...
-- Ajuste de seguridad para que el vacío no te mate durante el bug
...
-- 🔥 TEMPORIZADOR INTERNO SILENCIOSO
-- Espera a que el personaje esté cargado y con vida antes de bajar
task.spawn(function()
    repeat task.wait(0.5) until Humanoid.Health > 0 and HRP.Parent ~= nil
    task.wait(1) -- Tiempo extra de seguridad
    VoidDrop(char)
end)
end
